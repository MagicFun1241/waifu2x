...
download(`https://github.com/MagicFun1241/waifu2x/releases/download/${releaseTag}/${platform}.zip`, releaseFileName).then(() => {
    ...
    read.on("end", () => {
        ...
        fs.chmodSync(path.join(binaryDirectory, platform === 'win32' ? 'waifu2x-converter-cpp.exe' : 'waifu2x-converter-cpp'), 0o755);
